...
display name is passed as the second positional argument after `ANDROID`:
...
`npx -y firebase-tools@latest apps:sdkconfig ANDROID <APP_ID> --project <PROJECT_ID> --out app/google-services.json`
